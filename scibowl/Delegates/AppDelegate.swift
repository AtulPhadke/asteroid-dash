...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GIDSignIn.sharedInstance().clientID = "498497377939-vep8f06uosgvlehsbdiru5gulhh8hrnb.apps.googleusercontent.com"
    ...
    private func SplashScreenTiming(){
        ...
        Timer.scheduledTimer(timeInterval: 6, target: self, selector: #selector(DismissSpalshController), userInfo: nil, repeats: false)
    }
